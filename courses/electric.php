        ...
        <div class="row">
            <div class="col-md-6" style="margin-top: 1em;">
                <h4 class="text-center">
                    Reasons to study Electrical Enginnering 
                </h4>
                <p class="text-center" style="margin-right: 1em">Electrical & Electronic Engineering is a fascinating field, and one which could make your time at uni a challenging, enriching and rewarding experience.Just as the world needs its Doctors,Nurses and Teachers,Electrical Engineering is something which we simply couldn't do without.If you like the idea of creating electrical systems which could help millions of people on a day-to-day basis,like the systems used in phones,or computers,then you have the best reasons to study Electrical & Electronic Engineering and make your dreams comes true at Femina Training Institute.</p>
                <p class="text-center"  style="margin-right: 1em">With the rapid expansion of the technology sector over the last few decades,the demand for those who can create,understand and alter electrical control systems has risen accordingly. Computing for one is constantly evolving and therefore innovative new thinkers are required to configure new ideas and pave the way in electronics.</p>
            </div>
            <div class="col-md-6 text-center" style="margin-bottom: 1em">
              <h4 class="text-center">
                    Why We offer the study 
                </h4>
              <img src="../imgs/m.jpeg" class="img-fluid">
                <p>Electrical engineering is at the forefront of developing new technologies for a number of industries including transport, healthcare, construction, and robotics.What an exciting time to be alive and what an exciting time to be a electrical engineer.</p>
                <p>Electrical & Electronic Engineers therefore offer an unquantifiable benefit to society; if you want to be part of that then perhaps a diploma in Electrical & Electronic Engineering is the one for you.Thus,Femina Training Institute is your best destiny to achieve your dream in Electrical field.</p>

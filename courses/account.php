...
.my-container:before {
    ...
    z-index: 1;
    opacity: 0.8;
    background-image: url('../imgs/o.jpeg');
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 text-center" style="margin-bottom: 1em">
              ...
              <img src="../imgs/f.jpg" class="img-fluid"><br><br>
                <p>The primary role of accountants is to prepare and examine financial records. Accountants ensure the accuracy of a person’s or business’s financial records, and that bills and taxes are paid properly and on time.</p>
            </div>
        </div>
    </div>
</main>

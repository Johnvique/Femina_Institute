...
<div class="my-container">
    <h1 style="color: #000000">Supply Chain Management(Procurement)</h1>
</div>
<main>
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="margin-top: 1em;">
                <h4 class="text-center">
                    Overview about Supply Chain Management  
                </h4>
                <p class="text-center" style="margin-right: 1em">Supply chain management (SCM) involves the management of the flow of goods and services.It basically includes the movement and storage of raw materials,work-in-process inventory,finished goods from point of origin to point of consumption.Interconnected or interlinked networks,channels and node businesses are involved in the provision of products and services required by end customers in a supply chain.
                <p>Studying Procurement at Femina Institute enables our students to gain an in-depth understanding of supply chain strategy and sustainability, procurement strategy, supplier selection and evaluation, negotiation and contract management,how to analyse and design effective supply chain operations,how to use data,models and software to solve problems and inform decisions,inventory and operations management,accounting,freight transport and project management.</p>
            </div>
            <div class="col-md-6 text-center" style="margin-bottom: 1em">
              <h4>Why Procurement at Femina?</h4>
              <img src="../imgs/p.jpeg" class="img-fluid"><br><br>
                <p>Our aim is to develop procurement and supply chain professionals who can take the skills they develop on our programme and make a significant difference in the marketplace.Many of our faculty are regarded as leading experts in this area,combining excellent reputations for teaching with experience drawn from the commercial world.Our approach to teaching is designed to nurture your practical business skills and confidence,and places huge emphasis on real-world challenges.</p>
            </div>
        </div>
    </div>
</main>
